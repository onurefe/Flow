...
#define FLOW_ROOM_TEMPERATURE 22.0f
#define FLOW_RUN_SKIP 1
#define FLOW_CALIBRATION_SKIP 1
#define FLOW_SEARCHING_SKIP 1
#define FLOW_CALIBRATION_DOWNSAMPLING_NUMBER 20
#define FLOW_SEARCHING_DOWNSAMPLING_NUMBER 20
#define FLOW_RUN_GAIN (FLOW_INTERSENSOR_DISTANCE_IN_METERS * 6.283185307179586f * ((float)US_RUN_FREQ))
    ...
    typedef struct
    {
        Complex_t calibrationVector[CALIBRATION_SAMPLE_POINTS][FLOW_CHANNELS];
        float speedOfSound;
